...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            ...
            {{-- Search input --}}
            <input type="text" class="messenger-search" placeholder="Buscar pessoas ou grupos" />
            {{-- Tabs --}}
        ...
        <div class="m-body">
           ...
           <div class="@if($route == 'group') show @endif messenger-tab app-scroll" data-view="groups">
                {{-- items --}}
                <p style="text-align: center;color:grey;">Estará disponível em breve</p>
             </div>
           ...
           <div class="messenger-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint"><span>Digite para buscar..</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Selecione uma conversa para enviar mensagens</span></p>
            </div>
            {{-- Typing indicator --}}
